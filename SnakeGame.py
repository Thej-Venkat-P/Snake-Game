...
def SnakeGame() :
    ...
    class Snake:
        def __init__(self):
            ...
            for x,y in self.coordinates:
                square = canvas.create_rectangle(x,y,x+GameObjectSize,y+GameObjectSize,fill=SnakeColour,tag="snake")
    ...
    class Food:
        def __init__(self):
            ...
            canvas.create_oval(x,y,x+GameObjectSize,y+GameObjectSize,fill=FoodColour,tag="food")
    ...
    def game_over():
        ...
        canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                        font=("aria",GameObjectSize),text="GAME OVER",fill="red",tag="gameover")
